    ...
    <h2 class="text-center"><?php echo $person->name() ?></h2>
      ...
      <table class="table">
        ...
        if (!empty($bio)) {
          ...
          $minibio = preg_replace('/https\:\/\/'.str_replace(".","\.",$person->imdbsite).'\/name\/nm(\d{8}|\d{7})(\?ref_=nmbio_mbio)?/','?mid=\\1',$minibio);
          $minibio = preg_replace('/https\:\/\/'.str_replace(".","\.",$person->imdbsite).'\/title\/tt(\d{8}|\d{7})(\?ref_=nmbio_mbio)?/','movie.php?mid=\\1',$minibio);
        ?>
        <tr>
          <td><b>Mini Bio:</b></td>
          <td>
          ...
          <td>
            ...
            <ul>
              ...
              <li>
                <?php
                $t = $trivia[$i];
                $t = preg_replace('/https\:\/\/'.str_replace(".","\.",$person->imdbsite).'\/name\/nm(\d{8}|\d{7})(\?ref_=nmbio_trv_\d)?/','?mid=\\1',$t);
                $t = preg_replace('/https\:\/\/'.str_replace(".","\.",$person->imdbsite).'\/title\/tt(\d{8}|\d{7})(\?ref_=nmbio_trv_\d)?/','movie.php?mid=\\1',$t);
                echo $t;
                ?>
              </li>
              <?php } ?>
              ...
              <?php foreach ( $sal as $salary) { ?>
                <tr>
                  <td>
                    ...
                    <?php } else {
                      echo preg_replace('/\/title\/tt(\d{8}|\d{7})(\?ref_=nmbio_sal_\d)?/','movie.php?mid=\\1',$salary["movie"]["name"]);
                    } ?>
