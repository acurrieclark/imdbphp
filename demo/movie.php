    ...
    <h2 class="text-center"><?php echo $movie->title().' ('.$movie->year().')' ?></h2>
      ...
      <table class="table">
        ...
        <tr>
          ...
          <td><?php echo preg_replace("/https\:\/\/".str_replace(".","\.",$movie->imdbsite)."\/name\/nm(\d{8}|\d{7})\/(\?ref_=tt_trv_qu)?/","person.php?mid=\\1",$quotes[0]) ?></td>
        </tr>
        <?php } ?>
          ...
          <td>
            ...
            <ul>
              ...
              <li>
                <?php
                $t = $trivia[$i];
                $t = preg_replace('/https\:\/\/'.str_replace(".","\.",$movie->imdbsite).'\/name\/nm(\d{8}|\d{7})/','person.php?mid=\\1',$t);
                $t = preg_replace('/https\:\/\/'.str_replace(".","\.",$movie->imdbsite).'\/title\/tt(\d{8}|\d{7})/','movie.php?mid=\\1',$t);
                echo $t;
                ?>
              </li>
              <?php } ?>
          ...
          <td>
            ...
            <table>
              ...
              <?php foreach ( $soundtracks as $soundtrack) { 
                $credit1 = isset($soundtrack["credits"][0]) ? preg_replace("/https\:\/\/".str_replace(".","\.",$movie->imdbsite)."\/name\/nm(\d{8}|\d{7})\//","person.php?mid=\\1",$soundtrack["credits"][0]['credit_to'])." (".$soundtrack["credits"][0]['desc'].")" : '';
                $credit2 = isset($soundtrack["credits"][1]) ? preg_replace("/https\:\/\/".str_replace(".","\.",$movie->imdbsite)."\/name\/nm(\d{8}|\d{7})\//","person.php?mid=\\1",$soundtrack["credits"][1]['credit_to'])." (".$soundtrack["credits"][1]['desc'].")" : '';
              ?>
                <tr>
